...
public class Main {
    ...
    private static void insertarUsuario() {
        ...
        String nombre = Utilidades.pideDatoString("Nombre del usuario: ");
        String calle = Utilidades.pideDatoString("Calle del usuario: ");
        String ciudad = Utilidades.pideDatoString("Ciudad del usuario: ");
